          ...
          <div className='login-Form ml-[100px] p-[15px]'>
            ...
            <form onSubmit={loginAdmin}>
              <label htmlFor="Email" className='flex gap-[10px] pb-[5px] border-b-[1px] border-white w-[300px] pr-[5px] cursor-pointer mb-[30px]'>
                ...
                <input  onChange={(e)=> setLogin({...login, phone_number: e.target.value})} oninput="removeE(event)" placeholder='Telefon' id='Email' type="number" className='bg-transparent outline-none border-none text-white w-full text-[16px] font-medium' />
              </label>
              <label htmlFor="Password" className='flex gap-[10px] pb-[5px] border-b-[1px] border-white w-[300px]  cursor-pointer'>
                ...
                <input  onChange={(e)=> setLogin({...login,password:e.target.value})} placeholder='Parol' id='Password' type={passwordShown ? 'text' : 'password'} className='bg-transparent outline-none border-none text-white w-full text-[16px] font-medium' />
